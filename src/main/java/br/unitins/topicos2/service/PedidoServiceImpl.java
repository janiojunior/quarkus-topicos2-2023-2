...
import br.unitins.topicos2.dto.ItemPedidoDTO;
...
import br.unitins.topicos2.model.ItemPedido;
import br.unitins.topicos2.model.Pedido;
import br.unitins.topicos2.repository.FaixaRepository;
import br.unitins.topicos2.repository.PedidoRepository;
...
public class PedidoServiceImpl implements PedidoService {
    ...
    public PedidoResponseDTO insert(PedidoDTO dto, String login) {
        ...
        for (ItemPedidoDTO itemDto : dto.itens()) {
            ...
            Faixa faixa = faixaRepository.findById(itemDto.idFaixa());
            item.setFaixa(faixa);
